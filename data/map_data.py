...
SA_IPL = (
    ...
    ('DATA\\MAPS\\LA\\LAhills.IPL',        'LAhills', ''),
	    ('DATA\\MAPS\\lae_stream0.ipl',        'lae_stream0', ''),	
    ('DATA\\MAPS\\lae_stream1.ipl',        'lae_stream1', ''),	
    ('DATA\\MAPS\\lae_stream2.ipl',        'lae_stream2', ''),	
    ('DATA\\MAPS\\lae_stream3.ipl',        'lae_stream3', ''),	
    ('DATA\\MAPS\\lae_stream4.ipl',        'lae_stream4', ''),	
    ('DATA\\MAPS\\lae_stream5.ipl',        'lae_stream5', ''),	
    ('DATA\\MAPS\\lae2_stream0.ipl',       'lae2_stream0', ''),	
    ('DATA\\MAPS\\lae2_stream1.ipl',       'lae2_stream1', ''),	
    ('DATA\\MAPS\\lae2_stream2.ipl',       'lae2_stream2', ''),	
    ('DATA\\MAPS\\lae2_stream3.ipl',       'lae2_stream3', ''),	
    ('DATA\\MAPS\\lae2_stream4.ipl',       'lae2_stream4', ''),	
    ('DATA\\MAPS\\lae2_stream5.ipl',       'lae2_stream5', ''),	
    ('DATA\\MAPS\\lae2_stream6.ipl',       'lae2_stream6', ''),	
    ('DATA\\MAPS\\lahills_stream0.ipl',    'lahills_stream0', ''),	
    ('DATA\\MAPS\\lahills_stream1.ipl',    'lahills_stream1', ''),	
    ('DATA\\MAPS\\lahills_stream2.ipl',    'lahills_stream2', ''),	
    ('DATA\\MAPS\\lahills_stream3.ipl',    'lahills_stream3', ''),	
    ('DATA\\MAPS\\lahills_stream4.ipl',     'lahills_stream4', ''),	
    ('DATA\\MAPS\\lan_stream0.ipl',       'lan_stream0', ''),	
    ('DATA\\MAPS\\lan_stream1.ipl',       'lan_stream1', ''),	
    ('DATA\\MAPS\\lan_stream2.ipl',       'lan_stream2', ''),	
    ('DATA\\MAPS\\lan2_stream0.ipl',        'lan2_stream0', ''),	
    ('DATA\\MAPS\\lan2_stream1.ipl',        'lan2_stream1', ''),	
    ('DATA\\MAPS\\lan2_stream2.ipl',        'lan2_stream2', ''),	
    ('DATA\\MAPS\\lan2_stream3.ipl',        'lan2_stream3', ''),	
    ('DATA\\MAPS\\lan2_stream4.ipl',        'lan2_stream4', ''),	
    ...
    ('DATA\\MAPS\\las2_stream0.ipl',       'las2_stream0', ''),	
    ('DATA\\MAPS\\las2_stream1.ipl',       'las2_stream1', ''),	
    ('DATA\\MAPS\\las2_stream2.ipl',       'las2_stream2', ''),	
    ('DATA\\MAPS\\las2_stream3.ipl',       'las2_stream3', ''),	
    ('DATA\\MAPS\\las2_stream4.ipl',       'las2_stream4', ''),	
    ('DATA\\MAPS\\law_stream0.ipl',       'law_stream0', ''),	
    ('DATA\\MAPS\\law_stream1.ipl',       'law_stream1', ''),	
    ('DATA\\MAPS\\law_stream2.ipl',       'law_stream2', ''),	
    ('DATA\\MAPS\\law_stream3.ipl',       'law_stream3', ''),	
    ('DATA\\MAPS\\law_stream4.ipl',       'law_stream4', ''),	
    ('DATA\\MAPS\\law_stream5.ipl',       'law_stream5', ''),	
    ('DATA\\MAPS\\law2_stream0.ipl',       'law2_stream0', ''),	
    ('DATA\\MAPS\\law2_stream1.ipl',       'law2_stream1', ''),	
    ('DATA\\MAPS\\law2_stream2.ipl',       'law2_stream2', ''),	
    ('DATA\\MAPS\\law2_stream3.ipl',       'law2_stream3', ''),	
    ('DATA\\MAPS\\law2_stream4.ipl',       'law2_stream4', ''),	
    ('DATA\\MAPS\\lawn_stream0.ipl',       'lawn_stream0', ''),	
    ('DATA\\MAPS\\lawn_stream1.ipl',       'lawn_stream1', ''),	
    ('DATA\\MAPS\\lawn_stream2.ipl',       'lawn_stream2', ''),	
    ('DATA\\MAPS\\lawn_stream3.ipl',       'lawn_stream3', ''),
    ...
    ('DATA\\MAPS\\sfe_stream0.ipl',        'sfe_stream0', ''),	
    ('DATA\\MAPS\\sfe_stream1.ipl',        'sfe_stream1', ''),	
    ('DATA\\MAPS\\sfe_stream2.ipl',        'sfe_stream2', ''),	
    ('DATA\\MAPS\\sfe_stream3.ipl',        'sfe_stream3', ''),	
    ('DATA\\MAPS\\sfn_stream0.ipl',        'sfn_stream0', ''),	
    ('DATA\\MAPS\\sfn_stream1.ipl',        'sfn_stream1', ''),	
    ('DATA\\MAPS\\sfn_stream2.ipl',        'sfn_stream2', ''),	
    ('DATA\\MAPS\\sfs_stream0.ipl',        'sfs_stream0', ''),	
    ('DATA\\MAPS\\sfs_stream1.ipl',        'sfs_stream1', ''),	
    ('DATA\\MAPS\\sfs_stream2.ipl',        'sfs_stream2', ''),	
    ('DATA\\MAPS\\sfs_stream3.ipl',        'sfs_stream3', ''),	
    ('DATA\\MAPS\\sfs_stream4.ipl',        'sfs_stream4', ''),	
    ('DATA\\MAPS\\sfs_stream5.ipl',        'sfs_stream5', ''),	
    ('DATA\\MAPS\\sfs_stream6.ipl',        'sfs_stream6', ''),	
    ('DATA\\MAPS\\sfs_stream7.ipl',        'sfs_stream7', ''),	
    ('DATA\\MAPS\\sfs_stream8.ipl',        'sfs_stream8', ''),	
    ('DATA\\MAPS\\sfse_stream0.ipl',       'sfse_stream0', ''),	
    ('DATA\\MAPS\\sfse_stream1.ipl',       'sfse_stream1', ''),	
    ('DATA\\MAPS\\sfse_stream2.ipl',       'sfse_stream2', ''),	
    ('DATA\\MAPS\\sfse_stream3.ipl',       'sfse_stream3', ''),	
    ('DATA\\MAPS\\sfse_stream4.ipl',       'sfse_stream4', ''),	
    ('DATA\\MAPS\\sfse_stream5.ipl',       'sfse_stream5', ''),	
    ('DATA\\MAPS\\sfse_stream6.ipl',       'sfse_stream6', ''),	
    ('DATA\\MAPS\\sfw_stream0.ipl',        'sfw_stream0', ''),	
    ('DATA\\MAPS\\sfw_stream1.ipl',        'sfw_stream1', ''),	
    ('DATA\\MAPS\\sfw_stream2.ipl',        'sfw_stream2', ''),	
    ('DATA\\MAPS\\sfw_stream3.ipl',        'sfw_stream3', ''),	
    ('DATA\\MAPS\\sfw_stream4.ipl',        'sfw_stream4', ''),	
    ('DATA\\MAPS\\sfw_stream5.ipl',        'sfw_stream5', ''),
    ...
    ('DATA\\MAPS\\vegase_stream0.ipl',     'vegase_stream0', ''),	
    ('DATA\\MAPS\\vegase_stream1.ipl',     'vegase_stream1', ''),	
    ('DATA\\MAPS\\vegase_stream2.ipl',     'vegase_stream2', ''),	
    ('DATA\\MAPS\\vegase_stream3.ipl',     'vegase_stream3', ''),	
    ('DATA\\MAPS\\vegase_stream4.ipl',     'vegase_stream4', ''),	
    ('DATA\\MAPS\\vegase_stream5.ipl',     'vegase_stream5', ''),	
    ('DATA\\MAPS\\vegase_stream6.ipl',     'vegase_stream6', ''),	
    ('DATA\\MAPS\\vegase_stream7.ipl',     'vegase_stream7', ''),	
    ('DATA\\MAPS\\vegase_stream8.ipl',     'vegase_stream8', ''),	
    ('DATA\\MAPS\\vegasn_stream0.ipl',     'vegasn_stream0', ''),	
    ('DATA\\MAPS\\vegasn_stream1.ipl',     'vegasn_stream1', ''),	
    ('DATA\\MAPS\\vegasn_stream2.ipl',     'vegasn_stream2', ''),	
    ('DATA\\MAPS\\vegasn_stream3.ipl',     'vegasn_stream3', ''),	
    ('DATA\\MAPS\\vegasn_stream4.ipl',     'vegasn_stream4', ''),	
    ('DATA\\MAPS\\vegasn_stream5.ipl',     'vegasn_stream5', ''),	
    ('DATA\\MAPS\\vegasn_stream6.ipl',     'vegasn_stream6', ''),	
    ('DATA\\MAPS\\vegasn_stream7.ipl',     'vegasn_stream7', ''),	
    ('DATA\\MAPS\\vegasn_stream8.ipl',     'vegasn_stream8', ''),	
    ('DATA\\MAPS\\vegass_stream0.ipl',     'vegass_stream0', ''),	
    ('DATA\\MAPS\\vegass_stream1.ipl',     'vegass_stream1', ''),	
    ('DATA\\MAPS\\vegass_stream2.ipl',     'vegass_stream2', ''),	
    ('DATA\\MAPS\\vegass_stream3.ipl',     'vegass_stream3', ''),	
    ('DATA\\MAPS\\vegass_stream4.ipl',     'vegass_stream4', ''),	
    ('DATA\\MAPS\\vegass_stream5.ipl',     'vegass_stream5', ''),	
    ('DATA\\MAPS\\vegasw_stream0.ipl',     'vegasw_stream0', ''),	
    ('DATA\\MAPS\\vegasw_stream1.ipl',     'vegasw_stream1', ''),	
    ('DATA\\MAPS\\vegasw_stream2.ipl',     'vegasw_stream2', ''),	
    ('DATA\\MAPS\\vegasw_stream3.ipl',     'vegasw_stream3', ''),	
    ('DATA\\MAPS\\vegasw_stream4.ipl',     'vegasw_stream4', ''),	
    ('DATA\\MAPS\\vegasw_stream5.ipl',     'vegasw_stream5', ''),	
    ('DATA\\MAPS\\vegasw_stream6.ipl',     'vegasw_stream6', ''),	
    ('DATA\\MAPS\\vegasw_stream7.ipl',     'vegasw_stream7', ''),	
    ('DATA\\MAPS\\vegasw_stream8.ipl',     'vegasw_stream8', ''),	
    ('DATA\\MAPS\\vegasw_stream9.ipl',     'vegasw_stream9', ''),	
    ('DATA\\MAPS\\vegasw_stream10.ipl',    'vegasw_stream10', ''),	
    ('DATA\\MAPS\\vegasw_stream11.ipl',    'vegasw_stream11', ''),
    ('DATA\\MAPS\\country\\countryN.IPL',  'countryN', ''),
    ('DATA\\MAPS\\country\\countN2.IPL',   'countN2', ''),
    ('DATA\\MAPS\\country\\countrys.IPL',  'countrys', ''),
    ('DATA\\MAPS\\countrys_stream0.ipl',     'countrys_stream0', ''),	
    ('DATA\\MAPS\\countrys_stream1.ipl',     'countrys_stream1', ''),	
    ('DATA\\MAPS\\countrys_stream2.ipl',     'countrys_stream2', ''),	
    ('DATA\\MAPS\\countrys_stream3.ipl',     'countrys_stream3', ''),	
    ('DATA\\MAPS\\countrys_stream4.ipl',     'countrys_stream4', ''),
